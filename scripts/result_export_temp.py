    ...
    <body>
        ...
        <script>
            ...
            function updateChart() {{
                ...
                Plotly.newPlot('netCashFlowChart', netCashFlowData, netCashFlowLayout, createConfig(netCashFlowData));
                Plotly.newPlot('cumulativeCashFlowChart', cumulativeCashFlowData, cumulativeCashFlowLayout, createConfig(cumulativeCashFlowData));
